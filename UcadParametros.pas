...
type
  TCadParametros = class(TForm)
    ...
    CheckBox2: TCheckBox;
    CheckBox3: TCheckBox;
    Disci: THalcyonDataSet;
    DisciDIS_COD: TSmallintField;
    DisciDIS_NOME: TStringField;
    DisciDIS_RESUM: TStringField;
    DisciDIS_MAXFAL: TFloatField;
    Grade: THalcyonDataSet;
    GradeCUR_COD: TSmallintField;
    GradeSER_NUMERO: TSmallintField;
    GradeGRA_SEQ: TSmallintField;
    GradeDIS_COD: TSmallintField;
    GradeGRA_CHSEM: TSmallintField;
    GradeGRA_CHOF: TSmallintField;
    GradeGRA_CHNO: TSmallintField;
    GradeGRA_TIPO: TStringField;
    Mapa: THalcyonDataSet;
    MapaCUR_COD: TSmallintField;
    MapaSER_NUMERO: TSmallintField;
    MapaTUR_TURMA: TStringField;
    MapaTUR_ANOLET: TSmallintField;
    MapaMAP_DIASEM: TSmallintField;
    MapaMAP_AULA: TSmallintField;
    MapaDIS_COD: TSmallintField;
    Turma: THalcyonDataSet;
    TurmaCUR_COD: TSmallintField;
    TurmaSER_NUMERO: TSmallintField;
    TurmaTUR_TURMA: TStringField;
    TurmaTUR_ANOLET: TSmallintField;
    TurmaTUR_PERIOD: TStringField;
    TurmaTUR_VAGAS: TSmallintField;
    Nota: THalcyonDataSet;
    NotaALU_COD: TIntegerField;
    NotaDIS_COD: TSmallintField;
    NotaBIM_NUMERO: TStringField;
    NotaNOT_NOTA: TFloatField;
    Faltas: THalcyonDataSet;
    FaltasALU_COD: TIntegerField;
    FaltasDIS_COD: TSmallintField;
    FaltasFAL_DATA: TDateField;
    FaltasFAL_QTDE: TSmallintField;
    IBSQL1: TIBSQL;
    Recup: THalcyonDataSet;
    RecupALU_COD: TIntegerField;
    RecupDIS_COD: TSmallintField;
    RecupBIM_NUMERO: TStringField;
    RecupNOT_NOTA: TFloatField;
    Notas: TIBQuery;
    ...
    DiasLetivos: THalcyonDataSet;
    DiasLetivosLET_DATA: TDateField;
    DiasLetivosLET_DESC: TStringField;
    GroupBox1: TGroupBox;
    Label25: TLabel;
    DBEdit23: TDBEdit;
    Label24: TLabel;
    ...
    procedure MudaCorClick(Sender: TObject);
...
procedure TCadParametros.MudaCorClick(Sender: TObject);
begin
...
begin
  ...
  if MessageDlg('Distribui da '+SerX+'ª Série nas turmas?',mtConfirmation,mbOKCancel,0) = mrOK then begin
    ...
    Gauge2.Progress := 0;
    Gauge2.Show;
    DM.Turmas.SelectSQL.Strings[2] := 'where serie = '+SerX+' order by TURMA';
    DM.Turmas.Open;
    while not DM.Turmas.Eof do begin
      DM.Turmas.Edit;
