...
type
  TDoc_ContratoCurso = class(TQuickRep)
    Rodape: TQRBand;
    QRShape1: TQRShape;
    QRShape2: TQRShape;
    QRLabel33: TQRLabel;
...
var
  Doc_ContratoCurso: TDoc_ContratoCurso;
...
procedure TDoc_ContratoCurso.RodapeBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
