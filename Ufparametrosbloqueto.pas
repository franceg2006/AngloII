...
type
  Tfparametrosbloqueto = class(TForm)
    ...
    Bcursinho: TIBQuery;
    BcursinhoCURSINHO: TSmallintField;
   ...
   Begin
       ...
       3: begin
            ...
            Begin
                 ...
                 fparametrosbloqueto.Bcursinho.Close;
                 fparametrosbloqueto.Bcursinho.ParamByName('rgm').Value := dm.AlunosCODIGO.Value;
                 fparametrosbloqueto.Bcursinho.Open;
                //***************************************************************************
                 DM.Bloquetos.Insert;
                 dm2.sql_gen.Open;
                 DM.BloquetosNOSSO_NUMERO.AsInteger := DM2.sql_genCONTADOR.Value;
              ...
              if (fparametrosbloqueto.BcursinhoCURSINHO.Value <> 1) then
                 v_mensalidade := dm.ParametrosMENSALIDADE_3.Value
                 else v_mensalidade := dm.ParametrosMENSALIDADE_4.Value;

              if ((not (dm.AlunosBOLSA.IsNull)) and (dm.AlunosBOLSA.Value > 0)) then
                   dm.BloquetosDESCONTO.Value := ((v_mensalidade * dm.AlunosBOLSA.Value)/100)
                   else  dm.BloquetosDESCONTO.Value := ((v_mensalidade * dm.ParametrosREAJUSTE_3.Value)/100);
                   DM.BloquetosVALOR.Value       := v_mensalidade;
                   DM.BloquetosMENSALIDADE.Value := v_mensalidade;
                   DM.BloquetosVALOR_ANT.Value := dm.ParametrosMENSALIDADE_3.value;
                   DM.BloquetosMENSALIDADE_ANT.Value := 0;
                   DM.BloquetosDESCONTO_ANT.Value := ((dm.ParametrosMENSALIDADE_1.Value/100)/30);
                   DM.BloquetosVALOR_ANT.Value :=  dm.BloquetosMENSALIDADE.Value - dm.BloquetosDESCONTO.Value;
