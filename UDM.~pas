...
uses
  ...
  IBUpdateSQL, Halcn6DB, IBDatabaseInfo, IBEvents, IBSQLMonitor,
  DBTables, DateUtil;
...
type
  TDM = class(TDataModule)
    ...
    ParametrosVALOR_PONTUALIDADE4: TIBBCDField;
    BloquetosDATA_LIMITE: TDateField;
    SemiCPF_PAI: TIBStringField;
    SemiCPF_MAE: TIBStringField;
    SemiRG_PAI: TIBStringField;
    SemiRG_MAE: TIBStringField;
    BimestresINICIO_NOTA: TDateField;
    BimestresFIM_NOTA: TDateField;
    DsBloquetos_Delete: TDataSource;
    ...
    AlunosTIPOCERTIDAO: TIntegerField;
    ...
    AlunosPAR_FINAL: TIntegerField;
    AlunosORIUNDO_ESCOLA: TIntegerField;
    AlunosJAN: TIBStringField;
    AlunosFEV: TIBStringField;
    AlunosMARC: TIBStringField;
    AlunosABR: TIBStringField;
    AlunosMAI: TIBStringField;
    AlunosJUN: TIBStringField;
    AlunosJUL: TIBStringField;
    AlunosAGO: TIBStringField;
    AlunosSETE: TIBStringField;
    AlunosOUT: TIBStringField;
    AlunosNOV: TIBStringField;
    AlunosDEZ: TIBStringField;
...
begin
  if (dm.AlunosTURMA.Value = 'D') then
     dm.AlunosSerieX.Value := 'Cursinho'
  else
...
begin
  ...
  case DM.DocAlunosSERIE.Value of
    1 : if DM.DocAlunosH_ANO1.IsNull then begin
          ...
          DM.DocAlunosH_ESCOLA1.Value := 'COLÉGIO ANGLO UNIGRAN';
    ...
    2 : if DM.DocAlunosH_ANO2.IsNull then begin
          ...
          DM.DocAlunosH_ESCOLA2.Value := 'COLÉGIO ANGLO UNIGRAN';
    ...
    3 : if DM.DocAlunosH_ANO3.IsNull then begin
          ...
          DM.DocAlunosH_ESCOLA3.Value := 'COLÉGIO ANGLO UNIGRAN';
