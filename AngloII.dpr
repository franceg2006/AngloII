...
uses
  ...
  URel_QRFicha_Ocorrencia in 'URel_QRFicha_Ocorrencia.pas' {Rel_QRFicha_Ocorrencia: TQuickRep},
  ...
  UADM_Sincroniza in 'UADM_Sincroniza.pas' {ADM_Sincroniza},
  ...
  UBloquetoSemiInd in 'UBloquetoSemiInd.pas' {BloquetoSemiInd: TQuickRep},
  ...
  UEtiq_SPQR in 'UEtiq_SPQR.pas' {Etiquetas_SPQR: TQuickRep},
  ...
  UDoc_ContratoCursinho in 'UDoc_ContratoCursinho.pas' {Doc_ContratoCursinho: TQuickRep},
...
begin
  ...
  Application.CreateForm(TEtiquetas_SPQR, Etiquetas_SPQR);
  ...
  Application.CreateForm(Tfescola, fescola);
