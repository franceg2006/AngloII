...
uses UDM, ULst_AlunosQR, ULst_Alunos2QR, ULst_Alunos3QR, ULst_Alunos4QR,
  ...
  ULst_EnderecosAlunos, ULst_Sala_estudos;
...
//        Lst_EnderecosAlunos.Free;
 ...
 if Tipo.ItemIndex = 9 then begin
    Try
      with Lst_Sala_Estudos do begin
        Application.CreateForm(TLst_Sala_Estudos, Lst_Sala_Estudos);
        IqSalaEstudos.Close;
        IqSalaEstudos.Open;
        IqSalaEstudos.FetchAll;
        rlSl.Preview;
        end;
