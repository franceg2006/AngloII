...
begin
  ...
  Doc_AtaQR.D01.Caption := NomeDisc1(1);
  Doc_AtaQR.D02.Caption := NomeDisc1(2);
  Doc_AtaQR.D03.Caption := NomeDisc1(3);
  Doc_AtaQR.D04.Caption := NomeDisc1(4);
  Doc_AtaQR.D05.Caption := NomeDisc1(5);
  Doc_AtaQR.D06.Caption := NomeDisc1(6);
  Doc_AtaQR.D07.Caption := NomeDisc1(7);
  Doc_AtaQR.D08.Caption := NomeDisc1(8);
  Doc_AtaQR.D09.Caption := NomeDisc1(9);
  Doc_AtaQR.D10.Caption := NomeDisc1(10);
  Doc_AtaQR.D11.Caption := NomeDisc1(11);
  Doc_AtaQR.D12.Caption := NomeDisc1(12);
  Doc_AtaQR.D13.Caption := NomeDisc1(13);
  Doc_AtaQR.D14.Caption := NomeDisc1(14);
  Doc_AtaQR.D15.Caption := NomeDisc1(15);
  Doc_AtaQR.D16.Caption := NomeDisc1(16);
  Doc_AtaQR.D17.Caption := NomeDisc1(17);
  Doc_AtaQR.D18.Caption := NomeDisc1(18);
  Doc_AtaQR.E01.Caption := NomeDisc2(1);
  Doc_AtaQR.E02.Caption := NomeDisc2(2);
  Doc_AtaQR.E03.Caption := NomeDisc2(3);
  Doc_AtaQR.E04.Caption := NomeDisc2(4);
  Doc_AtaQR.E05.Caption := NomeDisc2(5);
  Doc_AtaQR.E06.Caption := NomeDisc2(6);
  Doc_AtaQR.E07.Caption := NomeDisc2(7);
  Doc_AtaQR.E08.Caption := NomeDisc2(8);
  Doc_AtaQR.E09.Caption := NomeDisc2(9);
  Doc_AtaQR.E10.Caption := NomeDisc2(10);
  Doc_AtaQR.E11.Caption := NomeDisc2(11);
  Doc_AtaQR.E12.Caption := NomeDisc2(12);
  Doc_AtaQR.E13.Caption := NomeDisc2(13);
  Doc_AtaQR.E14.Caption := NomeDisc2(14);
  Doc_AtaQR.E15.Caption := NomeDisc2(15);
  Doc_AtaQR.E16.Caption := NomeDisc2(16);
  Doc_AtaQR.E17.Caption := NomeDisc2(17);
  Doc_AtaQR.E18.Caption := NomeDisc2(18);
  ...
  Doc_AtaQR.Observacao.Lines.Text := EdObs.Text;
  Doc_AtaQR.Preview;
//  Doc_AtaQR.Free;
end;
